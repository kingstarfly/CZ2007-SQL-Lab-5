...
INSERT INTO Person(person_id, sex, birthday, hometown, risk_level, phone_number, name, company_id)
VALUES
...
INSERT INTO ContactPerson(person_id)
VALUES
    ('S9804253I'), 
    ('S1234567A'),
    ('S9810422D')
...
INSERT INTO Company(company_name, company_address, company_email, contact_person_id)
VALUES
...
INSERT INTO [Location](x_coordinates, y_coordinates, owner, description, address, name)
VALUES 
...
INSERT INTO PartOf(super_category_label, sub_category_label) 
VALUES 
    ('Mall', 'Cinema'),
...
INSERT INTO AssociatedWith(location_id, label)
VALUES
    (1, 'Mall'),
    (2, 'Condominium'),
    (3, 'MRT Station'),
...
INSERT INTO Family(person1_id, person2_id, relation_type)
VALUES
...
INSERT INTO CheckInOut(person_id, location_id, checkin_time, checkin_review, checkout_time, checkout_rating)
VALUES
...
INSERT INTO Post(person_id, location_id, timestamp, content)
VALUES
    ('S9804253I', 1, CONVERT(datetime, '2021-03-03 12:00:00'),'Jurong Point has nice shops!'), -- week 1 winner
    ('S9810422D', 3, CONVERT(datetime, '2021-03-05 12:00:00'),'Boon Lay MRT station is very close to JP!'),

    ('S1234567A', 2, CONVERT(datetime, '2021-03-10 12:00:00'),'North Hill has nice monkeys!'), -- week 2 winner
    ('S1234567A', 2, CONVERT(datetime, '2021-03-11 12:00:00'),'I love North Hill :D'), 

    ('S9810422D', 3, CONVERT(datetime, '2021-03-17 12:00:00'),'Boon Lay MRT station is very close to JP!'), -- week 3 winner
    
    ('S9804253I', 2, CONVERT(datetime, '2021-03-24 12:00:00'),'I live in North Hill.') -- week 4 winner
;
...
INSERT INTO Comment(post_id, commentor_id, comment, comment_timestamp)
VALUES 
    -- week 1
...
INSERT INTO SwabTest(person_id, location_id, [timestamp], test_result)
VALUES 
    ('S9804253I', 2, CONVERT(datetime, '2021-01-02 12:00:00'), 'Negative'),
    ('S1234567A', 2, CONVERT(datetime, '2021-01-03 12:00:00'), 'Negative'),
    ('S1234567A', 2, CONVERT(datetime, '2021-01-13 12:00:00'), 'Positive'),
...
INSERT INTO SystemAdmin(person_id)
VALUES
    ('S9823465D'),
    ('T0032522A')
;

INSERT INTO CoordinateRec(person_id, [timestamp], x_coordinates, y_coordinates)
VALUES 
    ('S1234567A', CONVERT(datetime, '2021-01-10 13:00:00'), 10,10),
    ('S1234567A', CONVERT(datetime, '2021-01-10 13:05:00'), 11,11),
    ('S1234567A', CONVERT(datetime, '2021-01-10 13:10:00'), 12,12),
    ('S1234567A', CONVERT(datetime, '2021-01-10 13:15:00'), 13,13),
    ('S1234567A', CONVERT(datetime, '2021-01-10 13:20:00'), 14,14),

    ('S9823465D', CONVERT(datetime, '2021-01-10 13:10:00'), 12,12),
    ('S9823465D', CONVERT(datetime, '2021-01-10 13:15:00'), 7,7)
;

INSERT INTO TemperatureRec(person_id, [timestamp], temperature)
VALUES
